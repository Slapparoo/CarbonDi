...
u64 entry__ = __onEnter();/*st*/ /*fc2 null */sprintf(/*fc2 null */getTmpBuffer(), "%lu", /*te14a*/((c_2106303_U64_cm*)useObject(/*te8*/this)->classmodel)->get_value(/*te8*/this));
...
/*cdv1*/((c_2106303_U64*)_c_2106303_U64)->instanceName = c_2106303_U64className();
...
void populatec_2106303_U64_cm(pointer classModel) {
 populatec_2106303_BaseBoxing_cm(classModel);
  ...
  thisClassModel->className = c_2106303_U64className;
  thisClassModel->classShortName = c_2106303_U64classShortName;
  thisClassModel->classCName = c_2106303_U64classCName;
  thisClassModel->classPackage = c_2106303_U64classPackage;
  thisClassModel->objectDatasize = c_2106303_U64objectDatasize;
