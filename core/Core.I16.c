...
u64 entry__ = __onEnter();/*st*/ /*fc2 null */sprintf(/*fc2 null */getTmpBuffer(), "%i", /*te14a*/((c_2106303_I16_cm*)useObject(this)->classmodel)->get_value(this));
...
num create_c_2106303_I16() {
  ...
  num this = createObject(_c_2106303_I16, getc_2106303_I16_cm(), false);
/*cdv2 Core.BaseBoxingCore.I16 */((c_2106303_I16*)_c_2106303_I16)->instanceName = c_2106303_I16className();
  return this;
}
...
void populatec_2106303_I16_cm(pointer classModel) {
 ...
 /*cds2*/ thisClassModel->datatype = c_2106303_I16datatype;
 /*cds2*/ thisClassModel->typename = c_2106303_I16typename;
 /*cds2*/ thisClassModel->asStr = c_2106303_I16asStr;
 /*cds2*/ thisClassModel->className = c_2106303_I16className;
 /*cds2*/ thisClassModel->classShortName = c_2106303_I16classShortName;
 /*cds2*/ thisClassModel->classCName = c_2106303_I16classCName;
 /*cds2*/ thisClassModel->classPackage = c_2106303_I16classPackage;
 /*cds2*/ thisClassModel->objectDatasize = c_2106303_I16objectDatasize;
 /*cds2*/ thisClassModel->get_value = c_2106303_I16get_value;
 /*cds2*/ thisClassModel->set_value = c_2106303_I16set_value;
