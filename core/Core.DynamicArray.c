...
void populatec_2106303_DynamicArray_cm(pointer classModel) {
 populatec_2106303_Array_cm(classModel);
  ...
  thisClassModel->className = c_2106303_DynamicArrayclassName;
  thisClassModel->classShortName = c_2106303_DynamicArrayclassShortName;
  thisClassModel->classCName = c_2106303_DynamicArrayclassCName;
  thisClassModel->classPackage = c_2106303_DynamicArrayclassPackage;
  thisClassModel->objectDatasize = c_2106303_DynamicArrayobjectDatasize;
