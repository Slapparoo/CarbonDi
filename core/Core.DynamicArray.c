...
/*fd1*/pointer c_2106303_DynamicArrayclassName(){
  return  "Core.DynamicArray";
}


/*fd1*/pointer c_2106303_DynamicArrayclassShortName(){
  return  "DynamicArray";
}


/*fd1*/pointer c_2106303_DynamicArrayclassCName(){
  return  "c_2106303_DynamicArray";
}


/*fd1*/pointer c_2106303_DynamicArrayclassPackage(){
  return  "Core";
}


/*fd1*/u64 c_2106303_DynamicArrayobjectDatasize(){
...
num create_c_2106303_DynamicArray() {
  ...
  num this = createObject(_c_2106303_DynamicArray, getc_2106303_DynamicArray_cm(), false);
/*cdv2 Core.ArrayCore.DynamicArray */((c_2106303_DynamicArray*)_c_2106303_DynamicArray)->instanceName = c_2106303_DynamicArrayclassName();
  return this;
}
...
void populatec_2106303_DynamicArray_cm(pointer classModel) {
 ...
 /*cds2*/ thisClassModel->getValue = c_2106303_DynamicArraygetValue;
 /*cds2*/ thisClassModel->setValue = c_2106303_DynamicArraysetValue;
 /*cds2*/ thisClassModel->addTail = c_2106303_DynamicArrayaddTail;
 /*cds2*/ thisClassModel->addHead = c_2106303_DynamicArrayaddHead;
 /*cds2*/ thisClassModel->insert = c_2106303_DynamicArrayinsert;
 /*cds2*/ thisClassModel->removeHead = c_2106303_DynamicArrayremoveHead;
 /*cds2*/ thisClassModel->removeTail = c_2106303_DynamicArrayremoveTail;
 /*cds2*/ thisClassModel->remove = c_2106303_DynamicArrayremove;
 /*cds2*/ thisClassModel->peekTail = c_2106303_DynamicArraypeekTail;
 /*cds2*/ thisClassModel->peekHead = c_2106303_DynamicArraypeekHead;
 /*cds2*/ thisClassModel->addCapacityHead = c_2106303_DynamicArrayaddCapacityHead;
 /*cds2*/ thisClassModel->addCapacityTail = c_2106303_DynamicArrayaddCapacityTail;
 /*cds2*/ thisClassModel->reduceCapacityHead = c_2106303_DynamicArrayreduceCapacityHead;
 /*cds2*/ thisClassModel->reduceCapacityTail = c_2106303_DynamicArrayreduceCapacityTail;
 /*cds2*/ thisClassModel->realignLeft = c_2106303_DynamicArrayrealignLeft;
 /*cds2*/ thisClassModel->slideLeft = c_2106303_DynamicArrayslideLeft;
 /*cds2*/ thisClassModel->slideRight = c_2106303_DynamicArrayslideRight;
 /*cds2*/ thisClassModel->className = c_2106303_DynamicArrayclassName;
 /*cds2*/ thisClassModel->classShortName = c_2106303_DynamicArrayclassShortName;
 /*cds2*/ thisClassModel->classCName = c_2106303_DynamicArrayclassCName;
 /*cds2*/ thisClassModel->classPackage = c_2106303_DynamicArrayclassPackage;
 /*cds2*/ thisClassModel->objectDatasize = c_2106303_DynamicArrayobjectDatasize;
 /*cds2*/ thisClassModel->get_startIndex = c_2106303_DynamicArrayget_startIndex;
 /*cds2*/ thisClassModel->set_startIndex = c_2106303_DynamicArrayset_startIndex;
 /*cds2*/ thisClassModel->get_endIndex = c_2106303_DynamicArrayget_endIndex;
 /*cds2*/ thisClassModel->set_endIndex = c_2106303_DynamicArrayset_endIndex;
 /*cds2*/ thisClassModel->get_initialSize = c_2106303_DynamicArrayget_initialSize;
 /*cds2*/ thisClassModel->set_initialSize = c_2106303_DynamicArrayset_initialSize;
 /*cds2*/ thisClassModel->get_growBy = c_2106303_DynamicArrayget_growBy;
 /*cds2*/ thisClassModel->set_growBy = c_2106303_DynamicArrayset_growBy;
 /*cds2*/ thisClassModel->get_slideAmount = c_2106303_DynamicArrayget_slideAmount;
 /*cds2*/ thisClassModel->set_slideAmount = c_2106303_DynamicArrayset_slideAmount;
