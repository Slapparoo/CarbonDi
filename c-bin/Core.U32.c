...
/*fd1*/pointer c_2106303_U32getClassName(){
  return  "Core.U32";
}


/*fd1*/pointer c_2106303_U32getClassShortName(){
  return  "U32";
}


/*fd1*/pointer c_2106303_U32getClassCName(){
  return  "c_2106303_U32";
}


/*fd1*/pointer c_2106303_U32getClassPackage(){
  return  "Core";
}


/*fd1*/u64 c_2106303_U32getObjectDatasize(){
