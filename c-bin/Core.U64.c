...
/*fd1*/pointer c_2106303_U64getClassName(){
  return  "Core.U64";
}


/*fd1*/pointer c_2106303_U64getClassShortName(){
  return  "U64";
}


/*fd1*/pointer c_2106303_U64getClassCName(){
  return  "c_2106303_U64";
}


/*fd1*/pointer c_2106303_U64getClassPackage(){
  return  "Core";
}


/*fd1*/u64 c_2106303_U64getObjectDatasize(){
