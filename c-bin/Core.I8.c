...
/*fd1*/pointer c_2106303_I8getClassName(){
  return  "Core.I8";
}


/*fd1*/pointer c_2106303_I8getClassShortName(){
  return  "I8";
}


/*fd1*/pointer c_2106303_I8getClassCName(){
  return  "c_2106303_I8";
}


/*fd1*/pointer c_2106303_I8getClassPackage(){
  return  "Core";
}


/*fd1*/u64 c_2106303_I8getObjectDatasize(){
