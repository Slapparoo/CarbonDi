...
/*fd1*/pointer c_2106303_F32getClassName(){
  return  "Core.F32";
}


/*fd1*/pointer c_2106303_F32getClassShortName(){
  return  "F32";
}


/*fd1*/pointer c_2106303_F32getClassCName(){
  return  "c_2106303_F32";
}


/*fd1*/pointer c_2106303_F32getClassPackage(){
  return  "Core";
}


/*fd1*/u64 c_2106303_F32getObjectDatasize(){
