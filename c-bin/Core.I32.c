...
u64 entry$ = __onEnter();return __exitReturn_int_un(/*te14*/((c_2106303_Boxing_cm*)getc_2106303_Boxing_cm())->get_i32_(), entry$);
}


pointer c_2106303_I32typename(){

u64 entry$ = __onEnter();return __exitReturn_pointer_un("i32", entry$);
}


pointer c_2106303_I32asStr(num this){

u64 entry$ = __onEnter();/**(Statement)*/ /*fc2 null */sprintf(/*fc2 null */getTmpBuffer(), "%i", /*te14a*/((c_2106303_I32_cm*)useObject(/*te8*/this)->classmodel)->get_value(/*te8*/this));
