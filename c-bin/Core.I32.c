...
/*fd1*/pointer c_2106303_I32getClassName(){
  return  "Core.I32";
}


/*fd1*/pointer c_2106303_I32getClassShortName(){
  return  "I32";
}


/*fd1*/pointer c_2106303_I32getClassCName(){
  return  "c_2106303_I32";
}


/*fd1*/pointer c_2106303_I32getClassPackage(){
  return  "Core";
}


/*fd1*/u64 c_2106303_I32getObjectDatasize(){
