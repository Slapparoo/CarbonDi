...
u64 entry$ = __onEnter();return __exitReturn_int_un(/*te14*/((c_2106303_Boxing_cm*)getc_2106303_Boxing_cm())->get_f64_(), entry$);
}


pointer c_2106303_F64typename(){

u64 entry$ = __onEnter();return __exitReturn_pointer_un("f64", entry$);
}


pointer c_2106303_F64asStr(num this){

u64 entry$ = __onEnter();/**(Statement)*/ /*fc2 null */sprintf(/*fc2 null */getTmpBuffer(), "%lf", /*te14a*/((c_2106303_F64_cm*)useObject(/*te8*/this)->classmodel)->get_value(/*te8*/this));
...
/* default constructor */
num create_c_2106303_F64$1(/* param *//*va1*/f64 value) {
