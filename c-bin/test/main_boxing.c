...
void tboolean() {
  ...
  printf(", getClassName=%s", cm->getClassName());
  ...
  printf("boolean value=%d", val);
  printf(", value=%d", ((c_2106303_B8*)objRef->data)->value);
  printf(", getClassName=%s", cm->getClassName(boxed));
...
void ti8() {
  ...
  printf(", name=%s", boxingi8ClassModel->getClassName(boxed));
...
void ti16() {
  ...
  printf(", name=%s", boxingi16ClassModel->getClassName(boxed));
...
void tu16() {
  ...
  printf(", value=%d", boxing->value);
  printf(", name=%s", boxingu16ClassModel->getClassName(boxed));
...
void tu32() {
  ...
  printf(", name=%s", boxingu32ClassModel->getClassName(boxed));
...
void ti32() {
  ...
  printf(", value=%i", boxing->value);
  printf(", name=%s", boxingi32ClassModel->getClassName(boxed));
...
void tf32() {
  ...
  printf(", name=%s", boxingf32ClassModel->getClassName(boxed));
...
void tu64() {
  ...
  printf(", name=%s", boxingu64ClassModel->getClassName(boxed));
...
void ti64() {
  ...
  printf(", name=%s", boxingi64ClassModel->getClassName(boxed));
...
void tf64() {
  ...
  printf(", value=%f", boxing->value);
  printf(", name=%s", boxingf64ClassModel->getClassName(boxed));
