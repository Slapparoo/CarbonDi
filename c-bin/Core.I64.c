...
/*fd1*/pointer c_2106303_I64getClassName(){
  return  "Core.I64";
}


/*fd1*/pointer c_2106303_I64getClassShortName(){
  return  "I64";
}


/*fd1*/pointer c_2106303_I64getClassCName(){
  return  "c_2106303_I64";
}


/*fd1*/pointer c_2106303_I64getClassPackage(){
  return  "Core";
}


/*fd1*/u64 c_2106303_I64getObjectDatasize(){
