...
u64 entry$ = __onEnter();return __exitReturn_int_un(/*te14*/((c_2106303_Boxing_cm*)getc_2106303_Boxing_cm())->get_u16_(), entry$);
}


pointer c_2106303_U16typename(){

u64 entry$ = __onEnter();return __exitReturn_pointer_un("u16", entry$);
}


pointer c_2106303_U16asStr(num this){

u64 entry$ = __onEnter();/**(Statement)*/ /*fc2 null */sprintf(/*fc2 null */getTmpBuffer(), "%u", /*te14a*/((c_2106303_U16_cm*)useObject(/*te8*/this)->classmodel)->get_value(/*te8*/this));
...
/* default constructor */
num create_c_2106303_U16$1(/* param *//*va1*/u16 value) {
