...
/*fd1*/pointer c_2106303_U16getClassName(){
  return  "Core.U16";
}


/*fd1*/pointer c_2106303_U16getClassShortName(){
  return  "U16";
}


/*fd1*/pointer c_2106303_U16getClassCName(){
  return  "c_2106303_U16";
}


/*fd1*/pointer c_2106303_U16getClassPackage(){
  return  "Core";
}


/*fd1*/u64 c_2106303_U16getObjectDatasize(){
