...
u64 entry_ = __onEnter();return __exitReturn_int_un(/*te14*/((c_2106303_Boxing_cm*)getc_2106303_Boxing_cm())->get_pointer_(), entry_);
}


pointer c_2106303_Pointertypename(){

u64 entry_ = __onEnter();return __exitReturn_pointer_un("pointer", entry_);
}


pointer c_2106303_PointerasStr(num this){

u64 entry_ = __onEnter();/**(Statement)*/ /*fc2 null */sprintf(/*fc2 null */getTmpBuffer(), "%p", /*te14a*/((c_2106303_Pointer_cm*)useObject(/*te8*/this)->classmodel)->get_value(/*te8*/this));
