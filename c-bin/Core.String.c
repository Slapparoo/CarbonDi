...
/*fd1*/pointer c_2106303_StringgetClassName(){
  return  "Core.String";
}


/*fd1*/pointer c_2106303_StringgetClassShortName(){
  return  "String";
}


/*fd1*/pointer c_2106303_StringgetClassCName(){
  return  "c_2106303_String";
}


/*fd1*/pointer c_2106303_StringgetClassPackage(){
  return  "Core";
}


/*fd1*/u64 c_2106303_StringgetObjectDatasize(){
