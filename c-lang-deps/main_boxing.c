...
void tboolean() {
    __onEnter();
    b8 val = true;
    num boxed = Boxing_b8_create(val);

    Boxingu8ClassModel *boxingb8ClassModel = (Boxingu8ClassModel *)useObject(boxed)->classmodel;
    Boxingu8 * boxing = (Boxingu8 *)useObject(boxed)->data;

    printf("boolean value=%d",  val);
    printf(", value=%d",  boxing->value);
    printf(", name=%s",  boxingb8ClassModel->name);
    printf(", type=%d",  boxingb8ClassModel->type(boxed));
    printf(", typename=%s",  boxingb8ClassModel->typename(boxed));
    printf(", asStr=%s\n",  boxingb8ClassModel->asStr(boxed));
...
void tu8() {
    __onEnter();
    u8 val = 254;
    num boxed = Boxing_u8_create(val);

    Boxingu8ClassModel *boxingu8ClassModel = (Boxingu8ClassModel *)useObject(boxed)->classmodel;
    Boxingu8 * boxing = (Boxingu8 *)useObject(boxed)->data;

    printf("u8 value=%d",  val);
    printf(", value=%d",  boxing->value);
    printf(", name=%s",  boxingu8ClassModel->name);
    printf(", type=%d",  boxingu8ClassModel->type(boxed));
    printf(", typename=%s",  boxingu8ClassModel->typename(boxed));
    printf(", asStr=%s\n",  boxingu8ClassModel->asStr(boxed));
...
void ti8() {
    ...
    printf(", name=%s",  boxingi8ClassModel->name);
...
void ti16() {
    ...
    printf(", value=%d",  boxing->value);
    printf(", name=%s",  boxingi16ClassModel->name);
...
void tu16() {
    ...
    printf(", value=%d",  boxing->value);
    printf(", name=%s",  boxingu16ClassModel->name);
...
void tu32() {
    ...
    printf(", name=%s",  boxingu32ClassModel->name);
...
void ti32() {
    ...
    printf(", value=%i",  boxing->value);
    printf(", name=%s",  boxingi32ClassModel->name);
...
void tf32() {
    ...
    printf(", name=%s",  boxingf32ClassModel->name);
...
void tu64() {
    ...
    printf(", name=%s",  boxingu64ClassModel->name);
...
void ti64() {
    ...
    printf(", name=%s",  boxingi64ClassModel->name);
...
void tf64() {
    ...
    printf(", value=%f",  boxing->value);
    printf(", name=%s",  boxingf64ClassModel->name);
